...
const updateChamado = async (req, res) => {
    ...
    // 1. ADICIONADO: Lendo o Usuarios_id do corpo da requisição.
    ...
    try {
        // 2. ADICIONADO: Um novo COALESCE para a coluna usuarios_id.
        const query = `
            UPDATE chamados 
            SET 
        ...
        // Adicionando o Usuarios_id à lista de parâmetros na ordem correta.
        ...
        // 3. ADICIONADO: Tratamento de erro para chave estrangeira.
        // Se o Usuarios_id enviado não existir na tabela de usuários, retorna um erro amigável.
        if (err.code === '23503') {
